...
namespace DVLD.Applications.RenewLocalLicense
{
    public partial class frmRenewLocalDrivingLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfowithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblTotalFees.Text = (Convert.ToSingle(lblApplicationFees.Text)).ToString() + Convert.ToSingle(lblLicenseFees.Text).ToString();

            txtNotes.Text = ctrlDriverLicenseInfowithFilter1.SelectedLicenseInfo.Notes;
            // check for Is LicenseExpired
            ...
            // check if it's not Active License 
        ...
        private void btnRenew_Click(object sender, EventArgs e)
        {
            ...
            lblRenewDrivingLicenseID.Text = NewLicense.ApplicationID.ToString();
